...
class base{
  public:
	 ...
	 */
	virtual num_t feature (index_type feature_index, index_type sample_index) const = 0;
	 ...
	 */
	virtual std::vector<num_t> features (index_type feature_index, std::vector<index_type> &sample_indices) const = 0;
	 ...
	 */
	virtual num_t weight(index_type sample_index) const = 0;
	 ...
	 *
	 */
	virtual void add_data_point (std::vector<num_t> features, response_type response, num_t weight) = 0;
	 ...
	 *
	 */
	virtual std::vector<num_t> retrieve_data_point (index_type index) const = 0;
