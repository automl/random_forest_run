...
typedef rfr::classification_split<rng_type, num_type, response_type, index_type> split_type;
...
BOOST_AUTO_TEST_CASE( data_container_tests ){
	rfr::mostly_continuous_data<num_type,response_type, index_type> data;
	...
	rfr::classification_forest< tree_type, rng_type, num_type, response_type, index_type> the_forest(forest_opts);
